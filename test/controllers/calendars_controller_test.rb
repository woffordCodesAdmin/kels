...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference("Calendar.count") do
      post calendars_url, params: { calendar: { date: @calendar.date, location: @calendar.location, meetingTime: @calendar.meetingTime } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { date: @calendar.date, location: @calendar.location, meetingTime: @calendar.meetingTime } }
